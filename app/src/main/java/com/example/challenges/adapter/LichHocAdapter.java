...
public class LichHocAdapter extends RecyclerView.Adapter<LichHocAdapter.LichHocViewHolder> {
    ...
    @NonNull
    @Override
    public LichHocAdapter.LichHocViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LichHocAdapter.LichHocViewHolder holder, int position) {
